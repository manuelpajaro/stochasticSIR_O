...
% [2020 11 01]    [2020 11 01]    [2020 10 25]    [2021 01 10]    [2020 10 25]
%                                 [2021 01 10]    [2021 01 24]    [2020 11 01]
%                                                                 [2020 12 20]
%                                                                 [2021 04 18]
...
simulation = SIRv_ssa(alpha,beta0,beta1,Tchange,x0,Imax,Tgrid,nsimula);
...
legend('Real','SSA')
title(['SIRv, ',locality,', ',num2str(f(1))],'Interpreter','latex')
set(gca,'FontSize',sizeL,'TickLabelInterpreter','latex')
